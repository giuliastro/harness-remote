...
assert.ok(panel.includes("attention: UNKNOWN_ATTENTION"), "working/reconnect boundaries must invalidate stale verified-empty attention before completion can be shown")
