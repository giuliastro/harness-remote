...
const crossMachine = read("components/cross-machine-continue-panel.tsx")
...
assert.match(crossMachine, /const modelRouteKey =/)
assert.match(crossMachine, /loadedModelRouteKey === modelRouteKey/)
assert.match(crossMachine, /\[open, machineID, modelRouteKey, agentID, onConnectionIssue\]/)
assert.doesNotMatch(crossMachine, /\[open, machineID, machine, agentID, onConnectionIssue\]/)
